...
import temptokenimage from '../assets/logo192.png'
...
const Swap = () => {
  return (
    <div className='flex justify-center items-center w-[100%] h-[90vh] bg-white' id='swap page'>
        ...
        <div className='text-left w-[180px] pb-[10px]' id='swap info'>
        ...
        <div className='flex flex-col text-left' id='what to swap'>
            <div className=' w-[100%] border-[2px] border-gray-300 bg-gradient-to-b from-gray-200 to-gray-300 rounded-[10px] h-[10vh] flex flex-row justify-between' id='token to swap'>
                ...
                <div className='flex flex-col ml-[10px] justify-around ' id='what token u have and amount of token'>
                    ...
                    <div className='flex items-center mt-[5px] flex-row justify-around w-[50px]' id='token dropdown'>
                        <img className=' h-[20px] w-[20px] mr-[5px]' src={temptokenimage} />
                    <p className=' text-[11px] flex flex-row' id='token dropdown menu with token logo and name'>
                        BUSD
                    </p>
                    </div>

                    <p className=' text-[23px]' id='token amount'>
                        9999.99
                    </p>
                ...
                <div className='flex flex-col mr-[10px] justify-around ' id='what token u have and amount of token'>
                    ...
                    <p className=' text-[23px] mt-[20px]' id='token amount'>
                        9999.99
                    </p>
            ...
            <div className=' w-[100%] bg-gradient-to-b from-gray-200 to-gray-300 rounded-[10px] h-[10vh] flex flex-row justify-between' id='token to swap'>
            ...
            <div className='flex mt-[12px] text-[12px] text-gray-500 justify-between' id='conversion rate component '>
                <p>
                    Conversion Rate:
                </p>
                <p>
        ...
        <div className=' flex flex-col justify-between w-[full] h-[28%]' id='confirmation'>
            ...
            <div id='swap statistic'>
                ...
                <div className='flex flex-row justify-between'>
                    <p className='text-[10px] text-gray-600' id='statistic name'>
                        Commision
                    </p>
            ...
            <div id='confim/connect-wallet button'>
                <button className='flex  justify-center items-center w-full h-[35px] rounded-[5px]  bg-[#80FE8C]'>
                    Connect Wallet
                </button>
            </div>
        </div>
